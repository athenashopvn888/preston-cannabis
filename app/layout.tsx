...
import "./globals.css";
export const metadata: Metadata = { metadataBase: new URL(SITE.domain), title: { default: "Preston Cannabis | Ottawa", template: "%s | Preston Cannabis" }, description: "Explore Preston Cannabis on Preston Street in Ottawa. Browse the menu preview and find contact information.", robots: { index: false, follow: false }, openGraph: { locale: "en_CA", siteName: SITE.name, type: "website" } };

...
test("owner-corrected street address and map target remain consistent", () => {
  ...
  assert.match(site, /fullAddress: "268 Preston St, Ottawa, ON K1R 7R5"/);
  ...
  assert.equal(maps.searchParams.get("query"), "268 Preston St, Ottawa, ON K1R 7R5");
  ...
  for (const file of ["lib/site.ts", "lib/editorial.ts", "app/page.tsx", "app/contact/page.tsx"]) {
    ...
    assert.doesNotMatch(content, /K1R 7R6/);
  }
});
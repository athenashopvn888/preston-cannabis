...
const child = spawn("cmd.exe", ["/d", "/s", "/c", commands[mode]], { env: { ...process.env, NODE_OPTIONS: "--use-system-ca", APPS_SCRIPT_URL: endpoint, MENU_STORE_CODE: "CHC01" }, stdio: ["inherit", "pipe", "pipe"], windowsHide: true });

...
export function flowerPrices(row) {
  return FLOWER_PRICE_FIELDS.flatMap((field) => {
    ...
    if (!label || !price || typeof price.regular !== "number" || !Number.isFinite(price.regular) || price.regular <= 0) return [];
...
export function normalizeMenu(data, requestedStore = APPROVED_STORE_CODE) {

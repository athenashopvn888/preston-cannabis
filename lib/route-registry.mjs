...
export const stableRoutes = ["/", "/menu", "/visit", "/hours", "/native-cigarettes", "/nicotine-vape", ...LANDING_ROUTES, "/exotic", "/premium", "/aaa", "/aa", "/budget", ...["flower", "pre-rolls", "vape-disposables", "edibles", "concentrates", "accessories", "nicotine-vapes", "cigarettes"].map((slug) => `/menu/${slug}`)];

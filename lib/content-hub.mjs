...
export const HOURS_STATUS = {
  // Honest: site/GBP verified hours are not published as 24h on this storefront.
  is24h: false,
  summary: "Call ahead for today's hours before you travel.",
  detail: "Preston Cannabis publishes contact details at 268 Preston St, Ottawa, ON K1R 7R5. Confirmed daily opening hours are verified by calling 343-804-9020 rather than guessing from a template.",
};
...
export const HOME_FAQS = [
  { question: "Where is Preston Cannabis?", answer: "Preston Cannabis is at 268 Preston St, Ottawa, ON K1R 7R5, in Little Italy between Carling and Somerset West." },
  ...
  { question: "How do I confirm store hours?", answer: "Call 343-804-9020 before you travel. This site does not publish a 24-hour claim for Preston Cannabis." },
...
export const VISIT_COPY = {
  ...
  description: "Directions, O-Train Line 2 / Carling notes, buses, parking, and landmarks for Preston Cannabis at 268 Preston St, Ottawa, ON K1R 7R5.",
  ...
  sections: [
    { heading: "Store pin", body: "Preston Cannabis — 268 Preston St, Ottawa, ON K1R 7R5. Phone 343-804-9020. Adults 19+." },
  ...
  faqs: [
    { question: "What is the exact address?", answer: "268 Preston St, Ottawa, ON K1R 7R5." },
    { question: "Does this page claim 24-hour opening?", answer: "No. Call 343-804-9020 to confirm hours before you travel." },
...
export const HOURS_COPY = {
  ...
  h1: "Store hours for Preston Cannabis on Preston Street",
  description: "Honest hours guidance for Preston Cannabis at 268 Preston St, Ottawa. Call 343-804-9020 to confirm today's opening times.",
  intro: "Preston Cannabis does not advertise a 24-hour schedule on this website. Use the phone line for the current opening window before you cross town.",
  sections: [
    { heading: "How to confirm hours", body: "Call 343-804-9020 and ask for today's open and close times. Holiday and event schedules can differ from a weekday pattern." },
    { heading: "What we will not invent", body: "This page will not publish guessed Monday-Sunday grids, overnight claims, or copied 24-hour language from another Ottawa store." },
    { heading: "Planning buffer", body: "If you are coming from Hintonburg, Dow's Lake, or across the river via Carling, build a few extra minutes for parking once hours are confirmed." },
  ],
  faqs: [
    { question: "Is Preston Cannabis open 24 hours?", answer: "This website does not claim 24-hour opening. Call 343-804-9020 for the verified schedule." },
    { question: "Where else can I check?", answer: "Use the Visit page for the address and map, then confirm timing by phone." },
  ],
};
...
export const NATIVE_CIG_COPY = {
  ...
  description: "Merchandise-category shelf language for Native cigarettes at Preston Cannabis, 268 Preston St, Ottawa, ON K1R 7R5. Adults 19+.",
...
export const NICOTINE_VAPE_COPY = {
  ...
  faqs: [
    ...
    { question: "Where is the store?", answer: "268 Preston St, Ottawa, ON K1R 7R5." },
  ],
};
